...
@rabbit_router.broker.handle(queue_return_data_about_order_to_order_servive, exchange_return_data_about_order_to_order_servive)
async def get_order_data_from_parser(message: dict):

    print('*************************************ORDER DATA FROM PARSER*************************************')
    print(message)
    print('=================================================================================================')
