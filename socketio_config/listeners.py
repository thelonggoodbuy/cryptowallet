from propan_config.router import queue_return_saved_messages, exchange_return_saved_messages, rabbit_router,\
                                    ...
                                    exchange_return_transaction_message_to_socket, queue_return_transaction_message_to_socket
...
@rabbit_router.broker.handle(queue_return_transaction_message_to_socket, exchange_return_transaction_message_to_socket)
async def return_transaction_message(message):
    print('------You----want----to----send---data----about---transaction---to---socket------')
    print(message)
    print('---------------------------------------------------------------------------------')